...
if ( ! class_exists( 'bS_Non_Latin_Languages' ) ) {
	/**
	 * Language handling.
	 */
	class bS_Non_Latin_Languages {
		...
		public static function get_non_latin_css( $type = 'front-end' ) {
			...
			return bs_generate_css( implode( ',', $elements[ $type ] ), 'font-family', implode( ',', $font_family[ $locale ] ), null, null, false );
