...
return [
  ...
  title: i18n.__('Block Content', 'extranavi-block'),
  className: 'block-content',
  initialOpen: true
  },
  el('p', {}, i18n.__('Add custom meta options to your block', 'extranavi-block')),
  el(TextControl, {
  type: 'text',
  label: i18n.__('Button Text', 'extranavi-block'),
  ...
  el(TextControl, {
  type: 'url',
  label: i18n.__('Button URL', 'extranavi-block'),
  ...
  el(
    ...
    style: { textAlign: attributes.alignment,border:'1px solid grey',paddingBottom:'10px' }
      ...
      style:{height:'120px'},
              ...
              !attributes.mediaID ? i18n.__('Upload Image', 'extranavi-block') : el('img', {src: attributes.mediaURL,
      style:{height:'120px'}})
            )
          }
        }
  ...
  placeholder: i18n.__('Title Text', 'extranavi-block'),
  ...
  placeholder: i18n.__('Text', 'extranavi-block'),
  keepPlaceholderOnFocus: true,
