( function(blocks, editor, components, i18n, element) {
  ...
  registerBlockType( 'bitv/testimonial', {
    title: 'Testimonial Modul', // The title of block in editor.
    icon: 'admin-comments', // The icon of block in editor.
    category: 'bitv-blocks', // The category of block in editor.
    edit: function() {
      return el( 'div', { style: { outline: '1px solid gray', padding: 5 } },
        el( 'span', {}, 'Testimonial Modul' ),
        el(
          InnerBlocks,
          {
            template: [
              ['core/image',{className:'testimonial-image','placeholder':'Testimonial-Bild'}],
              ['core/quote',{className:'testimonial-quote','placeholder':'Zitate / Author','ariaLabel':'hjsabvuhwsedbf'}],
            ],
            //templateLock: "all",
