...
return [
  el(
    'div', {
    className: '',
    style: { textAlign: attributes.alignment,border:'1px solid grey',padding:'10px 50px',display:'inline-block','width':'auto' }
    },
      ...
      placeholder: i18n.__('ButtonURL', 'lb'),
