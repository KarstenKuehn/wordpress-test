...
function my_block_template() {
    ...
    register_block_pattern(
        ...
        array('categories'  => array('lb_vorlagen'),      
            'title'     => 'extraNavi',
            'content'   => "<!-- wp:group -->\r\n<div class=\"wp-block-group\"><div class=\"wp-block-group__inner-container\"><!-- wp:columns {\"className\":\"content_section gray\"} -->\r\n<div class=\"wp-block-columns content_section gray\"><!-- wp:column -->\r\n<div class=\"wp-block-column\"><!-- wp:image {\"className\":\"navi-item\"} -->\r\n<figure class=\"wp-block-image navi-item\"><img alt=\"\"/></figure>\r\n<!-- /wp:image --></div>\r\n<!-- /wp:column -->\r\n\r\n<!-- wp:column -->\r\n<div class=\"wp-block-column\"><!-- wp:image {\"className\":\"navi-item\"} -->\r\n<figure class=\"wp-block-image navi-item\"><img alt=\"\"/></figure>\r\n<!-- /wp:image --></div>\r\n<!-- /wp:column -->\r\n\r\n<!-- wp:column -->\r\n<div class=\"wp-block-column\"><!-- wp:image {\"className\":\"navi-item\"} -->\r\n<figure class=\"wp-block-image navi-item\"><img alt=\"\"/></figure>\r\n<!-- /wp:image --></div>\r\n<!-- /wp:column --></div>\r\n<!-- /wp:columns --></div></div>\r\n<!-- /wp:group -->",
        )
    );
